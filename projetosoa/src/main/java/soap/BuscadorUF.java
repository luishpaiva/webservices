...
public class BuscadorUF {
	...
	@WebMethod(action = "buscarUFsCapitais")

	public ListaUF buscarUFsCapitais(@WebParam(name = "busca") String busca)  throws Exception {           
	...
	@WebMethod(action = "buscarUFsHabMaior")

	public ListaUF buscarUFsHabMaior(@WebParam(name = "busca") String busca)  throws Exception {           
	...
	@WebMethod(action = "buscarUFsHabMenor")

	public ListaUF buscarUFsHabMenor(@WebParam(name = "busca") String busca)  throws Exception {           
